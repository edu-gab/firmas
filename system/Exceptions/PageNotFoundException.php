...
class PageNotFoundException extends OutOfBoundsException implements ExceptionInterface
{
    ...
    public static function forPageNotFound(?string $message = null): static
    {
        return new static($message ?? self::lang('HTTP.pageNotFound'));
    }

    public static function forEmptyController(): static
    {
        return new static(self::lang('HTTP.emptyController'));
    }

    public static function forControllerNotFound(string $controller, string $method): static
    {
        return new static(self::lang('HTTP.controllerNotFound', [$controller, $method]));
    }

    public static function forMethodNotFound(string $method): static
    {
